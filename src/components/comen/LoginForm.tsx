  ...
  return (
    <div className='w-full  flex justify-center py-16'>
      <form className="p-6  w-[550px] bg-white rounded-xl shadow-2xl border border-gray-100">
        ...
        {/* Login button */}
        <Button radius="sm" className='w-full bg-[#FF6600] text-white font-lexend'>Login</Button>
        ...
        <div className="text-center mt-4">
          ...
          <Link to="/auth/users/sign-up" className="text-blue-500 hover:underline cursor-pointer inline-block ml-2">
            Sign In
          </Link>
        </div>
      </form>
