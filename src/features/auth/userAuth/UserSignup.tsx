    ...
    <div className="min-h-screen bg-gradient-to-r from-orange-100 via-white to-orange-100  flex flex-col items-center justify-center ">
      ...
      <div className='w-full  flex justify-center py-16'>
        ...
        <div className='text-center px-4 py-5 sm:px-6 md:px-8'>
          ...
          <p className='mt-2 text-sm sm:text-base md:text-lg'>Sign up to start your consultation with top doctors.</p>
        </div>
          ...
          <div className="text-center mt-4">
            ...
            <Link to="/auth/login" className="text-blue-500 hover:underline cursor-pointer inline-block ml-2">
              Sign In
            </Link>
          </div>
        </form>
